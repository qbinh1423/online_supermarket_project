...
const getProductMutation = useMutation({
  mutationFn: async () => {
    const res = await productService.getProductByCategory("đồ-gia-dụng");
    return res;
  },
  onSuccess: (data) => {
...
<template>
  <div class="adv-part-two">
    <div class="black-overlay"></div>
    <div class="row part-two">
      <div class="col-lg-3 col-md-5 col-sm-12 slide-product-two me-lg-5">
        <div class="slider-content">
          <transition :name="`slide-${direction}`" mode="out-in">
            <div class="slider-item" :key="currentIndex">
      ...
      <div class="col-lg-7 col-md-6 col-sm-12 content-on-bg ms-lg-5">
        <p>
          KHÁM PHÁ NHỮNG<br />SẢN PHẨM TIỆN ÍCH<br />CHO KHÔNG GIAN BẾP CỦA BẠN
        </p>
        <router-link to="/categories/đồ-gia-dụng" class="detail-btn2 mt-5">
          Chi tiết
        </router-link>
      </div>
    </div>
...
.slide-product-two .product-description {
  margin-top: 10px;
  width: 100%;
  display: -webkit-box;
...
.slide-product-two .product-price {
